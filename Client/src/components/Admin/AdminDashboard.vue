    ...
    <div class="row g-3">
      <div class="col-md-4">
        <div class="card text-white text-center" :style="{ backgroundColor: '#17a2b8' }">
          ...
          <div class="card-footer bg-transparent border-top-0">
            <router-link class="nav-link" :to="{ name: 'quanlysach' }"><small>Xem thêm <i
                  class="fas fa-arrow-circle-right"></i></small></router-link>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card text-white text-center" :style="{ backgroundColor: '#28a745' }">
          ...
          <div class="card-footer bg-transparent border-top-0">
            <router-link class="nav-link" :to="{ name: 'quanlynxb' }"> <small>Xem thêm <i
                  class="fas fa-arrow-circle-right"></i></small></router-link>
      ...
      <div class="col-md-4">
        <div class="card text-white text-center" :style="{ backgroundColor: '#fd7e14' }">
          ...
          <div class="card-footer bg-transparent border-top-0">
            <router-link class="nav-link" :to="{ name: 'quanlymuonsach' }"><small>Xem thêm <i
                  class="fas fa-arrow-circle-right"></i></small></router-link>
          </div>
        </div>
      </div>
      ...
      <div class="col-md-4">
        <div class="card text-white text-center" :style="{ backgroundColor: '#6f42c1' }">
          ...
          <div class="card-footer bg-transparent border-top-0">
            <router-link class="nav-link" :to="{ name: 'quanlydocgia' }"><small>Xem thêm <i
                  class="fas fa-arrow-circle-right"></i></small></router-link>
          </div>
        </div>
      </div>
