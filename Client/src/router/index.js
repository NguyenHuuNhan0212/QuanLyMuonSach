...
router.beforeEach((to, from, next) => {
  const isAdmin = sessionStorage.getItem("staffToken");

  // Nếu route bắt đầu bằng "/admin" nhưng KHÔNG phải "/admin-dang-nhap"
